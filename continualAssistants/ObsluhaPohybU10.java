...
//meta! id="102"
public class ObsluhaPohybU10 extends Process
{
	public ObsluhaPohybU10(int id, Simulation mySim, CommonAgent myAgent)
	{
	...
	//meta! sender="AgentPohybu", id="103", type="Start"
	...
	public void processMessage(MessageForm message)
	{
		...
		case Mc.start:
                    if (((MyMessage)message).dajObsluhovanehoZakaznika().dajZaparkoval()) {
                        ...
                        double dlzkaObsluhy = 13.0 / ((MyMessage)message).dajObsluhovanehoZakaznika().dajRychlostPeso();
                        message.setCode(Mc.finish);
                        hold(dlzkaObsluhy, message);
                    } else {
                        double dlzkaObsluhy = 13.0 / (20000 / 3600.0);
